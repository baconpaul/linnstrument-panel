...
3) LinnStrument has an RGB LED in every one of the 200 note pads. The Note Lights setting permits you to 
a) turn on or off each of the 12 notes in the chromatic scale in one color, and 
b) turn on or off each of the 12 notes in the chromatic scale in another accent color. 
